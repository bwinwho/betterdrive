...
- **Pictures is actually a gallery.** Just images, at any depth — folders and whatever non-photo files wander in there get filtered out of view, so it reads like a gallery instead of a general folder browser.
